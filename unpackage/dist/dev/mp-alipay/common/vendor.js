...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"uView-demo","VUE_APP_PLATFORM":"mp-alipay","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
// vuex_SongList 列表所有歌曲    vuex_nextId 下一首歌的id  vuex_currentId 当前歌的id
var saveStateKeys = ['vuex_user', 'vuex_token', 'vuex_SongList', 'vuex_nextId', 'vuex_currentId'];
